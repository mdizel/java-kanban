...
public class InputOutput {
    ...
    SubTask subTask = new SubTask("Закупить материалы", "Заказать материалы для строительства сарая", Status.IN_PROGRESS, 10004);
    SubTask subTask1 = new SubTask("Договорится с бригадой", "Найти бригаду, обсудить стоимость и сроки", Status.NEW, 10004);
    Epic epic1 = new Epic("Сделать ремонт в комнате", "Косметический ремонт в комнате на втором этаже", Status.NEW);
    SubTask subTask2 = new SubTask("Выбрать обои", "Обдумать цветовую гамму, купить обои и клей ", Status.NEW, 10007);
    Epic epic2 = new Epic("Перебрать мотор в тракторе", "Полная переборка с расточкой", Status.DONE);
    SubTask subTask3 = new SubTask("Проточить коленвал", "Отвезти коленвал в расточку", Status.NEW, 10009);
    SubTask subTask4 = new SubTask("Залить фундамент", "Заказать бетон, вызвать бетоннасос", Status.NEW, 10009);
    SubTask subTask5 = new SubTask("Привезти доски", "Привезти доски с рынка", Status.NEW, 10009);
    SubTask subTask6 = new SubTask("Просто подзадача к эпику...", "Добавление подзадачи к эпику по id эпика", Status.DONE, 10007);
    SubTask subTask7 = new SubTask("Ещеодна подзадача к эпику...", "Добавление2 подзадачи к эпику по id эпика", Status.DONE, 10007);
}
    /*
